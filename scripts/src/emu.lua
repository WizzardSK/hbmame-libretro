...
files {
	...
	MAME_DIR .. "src/emu/divo.cpp",
	MAME_DIR .. "src/emu/divo.h",
	...
	MAME_DIR .. "src/emu/screen_svg.cpp",
	MAME_DIR .. "src/emu/screen_svg.h",
	...
	MAME_DIR .. "src/emu/vector.cpp",
	MAME_DIR .. "src/emu/vector.h",
